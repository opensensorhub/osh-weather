...
package org.sensorhub.test.impl.sensor.uahweather;
...
import org.sensorhub.impl.sensor.uahweather.UAHweatherSensor;
...
public class TestUAHweatherDriver implements IEventListener
{
    UAHweatherSensor sensor;
    UAHweatherConfig config;
