    ...
    public void ParseAndSendCompMeasurement(String compInMessage)
    {
    	...
    	for (int cnt = 1; cnt < compMessage.length; cnt++)
    	{
    		...
    		/************************** Precip Messages ***************************/
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Rc token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Rc token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Rd token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Rd token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Ri token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Ri token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Hc token with invalid data!");
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Hc token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Hd token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Hd token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Hi token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Hi token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Rp token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Rp token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Hp token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Hp token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    		/**********************************************************************/
    		...
    		/************************ Supervisor Messages *************************/
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Th token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Th token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Vh token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Vh token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Vs token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Vs token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Vr token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Vr token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    			...
    			if (compMessage[cnt].endsWith("#"))
    			{
    				System.out.println("Got Id token with invalid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.NaN);
    				continue;
    			}
    			else
    			{
    				System.out.println("Got Id token with valid data @ iter " + cnt);
    				dataBlock.setDoubleValue(cnt, Double.parseDouble(compMessage[cnt].replaceAll("[^0-9.]", "")));
    				continue;
    			}
    		else
